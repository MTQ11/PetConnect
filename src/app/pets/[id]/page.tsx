...
import { Pet, Species, PetGender, HealthStatus, AgeUnit } from "@/types"
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-1 mb-2">
                    ...
                    <span className="text-sm text-gray-500">
                      ({petDetail.owner.reviewCount || 0} {t('reviews')})
                    </span>
                  </div>
                  <p className="text-sm text-gray-600">
                    {t('memberSince')} {new Date(petDetail.owner.createdAt).getFullYear()}
                  </p>
                </div>
              </div>
